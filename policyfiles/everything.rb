...
run_list 'managed_automate::airgap_bundle', 'managed_automate::default', 'managed_automate::backup'

override['ma']['chef-automate'] = '/tmp/test/chef-automate'
override['ma']['aib']['dir'] = '/tmp/test'
override['ma']['install']['url'] = 'file://localhost/tmp/test/automate-20181020020209.aib'
